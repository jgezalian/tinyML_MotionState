...
for motion in discrete_motions:
    ...
    df = pd.read_csv(f"../drive_data/clean/train/{motion}/{motion}.csv")
...
discrete_df.to_csv("train/discrete_features.csv")
continuous_df = pd.DataFrame(continuous_feature_rows)
continuous_df.to_csv("train/continuous_features.csv")
