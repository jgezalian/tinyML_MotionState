...
# hard_accel_decel
csv = "../drive_data/first_and_second_combined_raw/hard_accel_decel/combined_train.csv"
df = pd.read_csv(csv)
...
decel.to_csv("../drive_data/first_and_second_combined_clean/hard_accel_decel/decel/decel.csv")
...
accel.to_csv("../drive_data/first_and_second_combined_clean/hard_accel_decel/accel/accel.csv")
...
def plot_all_attributes(attributes):
    for attribute in attributes:
        ...
        plt.grid(True)
        plt.savefig(
            f"../drive_data/first_and_second_combined_clean/hard_accel_decel/decel/{attribute}.png"
        )
        ...
        plt.grid(True)
        plt.savefig(
            f"../drive_data/first_and_second_combined_clean/hard_accel_decel/accel/{attribute}.png"
        )
