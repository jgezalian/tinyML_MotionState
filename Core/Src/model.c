...
static const char *MOTION_CLASS_NAMES[N_CLASSES] = {
    "bumps",        "clockwise_circle", "constant_speed", "ctr_clockwise_circle", "hard_accel",
    "hard_decel",   "left_turn",        "left_u_turn",    "right_turn",           "right_u_turn",
    "smooth_accel", "smooth_decel",     "weave"};
